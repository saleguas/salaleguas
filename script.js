...
function add_fields() {
 ...
 //document.getElementById('wrapper').innerHTML += '<input class="names" placeholder="Course name" type="text" id = "textOne">';
   ...
   // document.getElementById('wrapper').innerHTML += '<input class="credits" placeholder="Credits" type="number" id = "textOne">';
    divtest.innerHTML = '<span class = "added"><input class="names" placeholder="Course name" type="text" id = classID><select class = "grades" id = classID><option value = -1>--</option><option value = 4>A</option><option value = 3>B+</option><option value = 3>B</option><option value = 2>C+</option> <option value = 2>C</option><option value = 1>D+</option><option value = 1>D</option><option value = 0>F</option></select><select class = "classType" id = "classType"><option value = -1>--</option><option value = 2>AICE</option><option value = 2>AP</option><option value = 1>Honors</option><option value = 0>Regular</option></select><input class="credits" placeholder="Credits" type="number" id = classID></span>'
...
function calculateWeighted(){
    ...
    total += (document.getElementById("currentWeightedGpa").value * document.getElementById("currentCredits").value);
    creditsTotal += document.getElementById("currentCredits").value;
...
function calculateUnweighted(){
    ...
    total += (document.getElementById("currentUnweightedGpa").value * document.getElementById("currentCredits").value);
    creditsTotal += document.getElementById("currentCredits").value;
    return (total / creditsTotal);
